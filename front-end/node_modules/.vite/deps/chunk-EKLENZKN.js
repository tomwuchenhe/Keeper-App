...
var Portal = React15.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React15.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime19.jsx)(React15.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime19.jsx)(React15.Fragment, {
...
var Backdrop = React17.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime21.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
var Modal = React19.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime22.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime23.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime22.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime22.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
var Popover = React20.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime24.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent_default(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
    children: (0, import_jsx_runtime24.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime24.jsx)(PaperSlot, _extends({}, paperProps, {
        children
      }))
    }))
  }));
...
var Menu = React21.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime25.jsx)(MenuMenuList, _extends({
...
var NativeSelectInput = React22.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React22.Fragment, {
    children: [(0, import_jsx_runtime26.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime26.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React23.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React23.Fragment, {
    children: [(0, import_jsx_runtime28.jsx)(SelectSelect, _extends({
    ...
    })), (0, import_jsx_runtime28.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime28.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime28.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
var TextField = React26.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime32.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime33.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime32.jsx)(InputLabel_default, _extends({
      ...
      children: label
    })), select ? (0, import_jsx_runtime32.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime32.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
//# sourceMappingURL=chunk-EKLENZKN.js.map
